...
/* SD Card definitions: Change these to fit your application when using
   an SD-card-based physical layer                                   */
        ...
        // Card detect signal
        #define SD_DETECT               PORTBbits.RB4
        #define SD_DETECT_TRIS          TRISBbits.TRISB4
	...
	//PM
        ...
        // Will generate an error if the clock speed is too low to interface to the card
	        ...
	        #define SD_DETECT               PORTFbits.RF0
	        // Description: SD-SPI Card Detect TRIS bit
	        #define SD_DETECT_TRIS          TRISFbits.TRISF0
			...
			// Description: SD-SPI Card Detect Input bit
			#define SD_DETECT   PORTAbits.RA15

			// Description: SD-SPI Card Detect TRIS bit
			#define SD_DETECT_TRIS  TRISAbits.TRISA15
        ...
        // Will generate an error if the clock speed is too low to interface to the card
            ...
            // Description: SD-SPI Card Detect Input bit
            #define SD_DETECT               PORTGbits.RG0
            // Description: SD-SPI Card Detect TRIS bit
            #define SD_DETECT_TRIS          TRISGbits.TRISG0
    ...
    #define SD_DETECT_TRIS          TRISGbits.TRISG9
    ...
    // Description: SD-SPI Card Detect and TRIS bits
    #define SD_DETECT               PORTEbits.RE8 
    #define SD_DETECT_TRIS          TRISEbits.TRISE8
