...
printf("\rDisk Mount DONE");    
printf("\rError: %d, Sector Size: %d, Type: %d, Mount: %d", (int)error, (int)dsk->sectorSize, (int)dsk->type, (int)dsk->mount);
#endif
    return(error);
} // -- mount
...
#ifdef SD_DIAGNOSTICS    
    printf("\rFile name length: %d", (int)fileNameLength);
#endif    
...
#ifdef SD_DIAGNOSTICS
                        printf("\rFF #4C, mode: %d, FN length: %d, LFN Seq: %d, Seq: %d", (int)mode, (int)fileNameLength, (int)lfnObject.LFN_SequenceNo, (int)lfnMaxSequenceNum);
#endif                         
